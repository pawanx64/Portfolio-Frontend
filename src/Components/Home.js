...
export const Home = () => {
  ...
  return (
    <div className="bg-cover bg-center h-screen flex flex-col">
      <Navbar />
      <div data-aos="zoom-in" className="h-screen flex flex-col lg:flex-row items-center justify-center lg:justify-evenly px-5 py-10 lg:py-0 lg:px-20">
        <div className="flex-shrink-0 mb-8 lg:mb-0">
          <img src={image} alt="logo" className="rounded-3xl w-72 h-72" />
        </div>
        <div className="text-center lg:text-left lg:ml-8">
          <div className="mb-4">
            <span className="text-[28px] lg:text-[48px] font-serif font-semibold text-yellow-200">Hello I'm Pawan</span>
          </div>
          <div className="mb-8">
            <span className="text-[16px] sm:text-[20px] md:text-[24px] lg:text-[28px] font-semibold text-orange-400">{typeEffect}</span>
          </div>
